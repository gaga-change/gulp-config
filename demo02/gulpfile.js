...
gulp.task('less', function () {
    return gulp.src('src/less/**/*.less')
        ...
        .pipe(changed(dir.dist.css, {extension: '.css'}))
        .pipe(less({
            plugins: [autoprefix],
...
gulp.task('lib', () => gulp.src('src/lib/**/*').pipe(gulp.dest(dir.dist.lib)))

gulp.task('serve', ['clean'], () => {
    browserSync.init({
        server: "./dist"
    });
    gulp.start(['less', 'js', 'img', 'page', 'lib'])
